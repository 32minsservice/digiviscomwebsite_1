  ...
  return (
    <footer style={{ backgroundColor: '#201E18' }} className="text-white py-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10">
          ...
          <div 
            ...
            className="rounded-lg p-6 md:p-8 text-center md:text-left cursor-pointer hover:bg-opacity-90 transition-all duration-300"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-center mb-12">
          ...
          <div className="text-center lg:text-left">
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4 font-cabinet">{t.joinToday}</h3>
        ...
        {/* Bottom Section */}
        <div className="flex flex-col lg:flex-row justify-between items-center border-t border-gray-700 pt-8 w-full space-y-6 lg:space-y-0">
          {/* Left - Follow us with icons inline */}
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4">
            <p className="text-gray-400 text-sm font-cabinet text-center sm:text-left">{labels.followUs}</p>
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6 text-sm">
            <a href="#" className="text-gray-400 hover:text-white transition-colors font-cabinet text-center">{labels.privacyPolicy}</a>
            <a href="#" className="text-gray-400 hover:text-white transition-colors font-cabinet text-center">{labels.termsConditions}</a>
          </div>
        </div>

        {/* Copyright */}
        <div className="text-center mt-8 pt-6 border-t border-gray-700">
          <p className="text-gray-400 text-sm font-cabinet px-4">
            ...
            >
              32Mins Digital Consultancy Services
            </a>
          </p>
        </div>
      </div>
