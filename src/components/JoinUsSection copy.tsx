...
import FileDown from "../assets/file-down.png";
import proposalPdf from "../assets/DigiViscom Project Proposal.pdf";
...
const JoinHandsSection = () => {
  ...
  const handleDownloadProposal = () => {
    ...
    link.href = "/DigiViscom Project Proposal.pdf";
    link.download = "DigiViscom_Project_Proposal.pdf";
    link.target = "_blank";
    link.click();
  };
  ...
  const modalContent = {
    ...
    description:
      language === "en"
        ...
        : "தயவு செய்து உங்கள் விவரங்களை வழங்குங்கள், நாங்கள் விரைவில் உங்களைத் தொடர்பு கொள்வோம்.",
    ...
    submitButton:
      language === "en" ? "Submit Application" : "விண்ணப்பம் சமர்பிக்கவும்",
  };
  ...
  const downloadButtonText = {
    text:
      language === "en"
        ...
        : "திட்ட முன்மொழிவு ஆவணம்",
  };

  return (
    <>
      <section id="join-us" className="py-12 sm:py-16 lg:py-20">
        <div className="py-4 sm:py-6 lg:py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-6 sm:mb-8">
              ...
              <p
                className="text-lg sm:text-xl text-teal-600 font-medium"
                style={{ color: "#169397" }}
              >
                {content.subtitle}
              </p>
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 px-2 sm:px-0">
                <button
                  ...
                  className="group bg-gradient-to-r hover:from-orange-600 hover:to-orange-700 text-white font-semibold py-3 sm:py-4 px-4 sm:px-6 rounded-xl w-full transform transition-all duration-200 hover:scale-105 flex items-center justify-between"
